...
PACKAGES="archlinux-keyring base base-devel linux linux-firmware mkinitcpio lvm2 nano wpa_supplicant dialog netctl net-tools dhcpcd git openssh wget go acpi"
if [ ${USE_EFI} == "y" ]; then
